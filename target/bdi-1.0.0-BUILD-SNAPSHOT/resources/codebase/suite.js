...
var Window = /** @class */ (function () {
    ...
    Window.prototype.show = function (left, top) {
        ...
        this.config.left = left = core_1.isDefined(left) ? left : (window.innerWidth - width) / 2;
        this.config.top = top = core_1.isDefined(top) ? top : (window.innerHeight - height) / 2;
        if (this._isActive) {
